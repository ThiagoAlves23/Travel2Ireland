...
class Place_visit_Form(forms.ModelForm):
    ...
    description_place = forms.CharField(max_length=10000, required=True,  widget=forms.Textarea(attrs={"class": "textarea is-success is-medium",'placeholder': 'description here '}))
